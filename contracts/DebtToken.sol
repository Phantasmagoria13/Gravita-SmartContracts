...
contract DebtToken is IDebtToken, ERC20Permit, Ownable {
	...
	bytes32 public constant NAME = "GRAI";
	...
	function mint(
		...
		require(!emergencyStopMintingCollateral[_asset], "This collateral is blocked");
